/* Victor Hub AI — semente operacional.
   Datas relativas são carimbadas na primeira abertura para o cockpit nascer em "hoje". */
(function () {
  ...
  function buildSeed() {
    ...
    return {
      ...
      profile: {
        ...
        role: "Owner",
        version: "v1.0",
        objective: "Entregar sistemas, interfaces e automações que vendem — com o estúdio inteiro no mesmo cockpit.",
      ...
      clients: [
        {
          ...
          nextAction: "Enviar a proposta do Portal Lux hoje, às 17:00 — tom sóbrio, hero 3D, sem estoque genérico.",
          projectId: "lux",
          notes: "Decide com o sócio. Quer referência de portal imobiliário de alto padrão, luz baixa e tipografia editorial. Sensível a prazo de kickoff.",
          timeline: [
            { at: at(-3, 11, 20), text: "Enviou referências de portais em Dubai e pediu um tom mais sóbrio no hero." },
            { at: at(-6, 15, 0), text: "Call de descoberta: 40 unidades, prioridade no mapa e no tour 3D." },
            { at: at(-12, 9, 40), text: "Lead qualificado entrou pelo formulário do site." },
          ],
        },
        {
          id: "rafael",
          ...
          nextAction: "Ajustar a objeção da dobra 2 e pedir a aprovação final até sexta.",
          projectId: "alpha",
          notes: "Pagou a primeira parcela. Trava em adjetivo vazio — quer resultado concreto, não 'revolucione'.",
          timeline: [
            { at: at(-1, 18, 40), text: "Pediu troca da frase da dobra 2 antes de aprovar." },
            { at: at(-6, 10, 15), text: "Pagou R$ 6.000 da parcela inicial da landing." },
            { at: at(-14, 16, 0), text: "Aprovou a direção visual da Alpha AI." },
          ],
        },
        {
          id: "marina",
          ...
          nextAction: "Fechar a animação do hero e mandar o draft v2 na segunda.",
          projectId: "nexus",
          notes: "Cliente ativo e exigente com motion. O glow vermelho não pode competir com a marca Nexus.",
          timeline: [
            { at: shiftMin(-120), text: "Cobrou o hero animado para liberar o draft v2 do site." },
            { at: at(-4, 14, 10), text: "Validou paleta e tipografia do rebranding." },
            { at: at(-16, 11, 0), text: "Kickoff Nexus OS — escopo de identidade + site v2." },
          ],
        },
      ],
      projects: [
        {
          ...
          brief: "Portal de alto padrão para a Prime Real Estate. Mapa de empreendimentos, ficha de unidade, tour e captação de lead qualificado. A descoberta ainda trava no tom: luz baixa, tipografia editorial, zero banco de imagem genérico.",
          notes: "Proposta sai hoje às 17:00. Não prometer o hero 3D completo no kickoff — prometer direção, enquadramento e uma cena de prova.",
          milestones: [
        ...
        },
        {
          ...
          brief: "Landing de conversão para a Startup Venture. Copy em revisão final, prova e CTA de demo. Falta a aprovação do Rafael e o ajuste de uma objeção na dobra 2.",
          notes: "Trocar 'revolucione sua operação' por um resultado numerado. Rafael responde melhor no fim da tarde.",
          milestones: [
        ...
        },
        {
          ...
          brief: "Rebranding do produto Nexus OS: identidade, sistema visual e site v2. O draft está bloqueado pela animação do hero. Marina quer presença, não espetáculo — o glow vermelho entra contido.",
          notes: "Crítico. Se o hero não fechar até sexta, o draft v2 escorrega e a parcela 2 fica desconfortável.",
          milestones: [
      ...
      tasks: [
        {
          ...
          order: 2,
          detail: "Glow contido, loop de 8s, peso leve o bastante para o hero não atrasar o LCP. Exportar mp4 de prova e o componente.",
        },
        {
          id: "t-stripe",
          ...
          order: 1,
          detail: "A assinatura do webhook está falhando por drift de timestamp. Conferir segredo no n8n, tolerância de 300s e o canal #pagamentos.",
        },
        {
          id: "t-copy",
          ...
          order: 4,
          detail: "Dobra 2: tirar adjetivo vazio, colocar o resultado da demo em uma frase. Mandar para o Rafael ainda hoje.",
        },
        {
          id: "t-proposta",
          ...
          order: 3,
          detail: "Escopo em três fases, investimento de R$ 48.000, kickoff 3D como marco — não como entrega final. Tom sóbrio.",
        },
        {
          id: "t-pub",
          ...
          order: 5,
          detail: "Só publicar com o ok escrito do Rafael. Conferir meta, evento de lead e velocidade.",
        },
        {
          id: "t-draft",
          ...
          order: 6,
          detail: "Site v2 com hero aprovado, páginas de produto e handoff comentado.",
        },
        {
          id: "t-kick",
          ...
          order: 7,
          detail: "Uma cena de prova, enquadramento e lista do que a Prime precisa entregar de inventário.",
        },
      ],
      automations: [
        {
          ...
          successRate: 100,
          avg: "42s",
          summary: "Fluxo operacional conectado ao seu ecossistema. Histórico e estado ficam registrados no Hub.",
          nodes: [
          ...
          fixes: null,
          logs: [
            { at: backupStamp(), ok: true, msg: "Snapshot concluído · 3 repositórios · main protegida" },
            { at: at(-1, 3, 0), ok: true, msg: "Snapshot concluído · sem divergência" },
            { at: at(-2, 3, 0), ok: true, msg: "Snapshot concluído · tag noturna criada" },
          ],
        },
        {
          id: "lead",
          ...
          successRate: 99.4,
          avg: "6s",
          summary: "Todo lead do site entra qualificado no radar, com origem, interesse e próxima ação.",
          nodes: [
          ...
          fixes: null,
          logs: [
            { at: shiftMin(-3), ok: true, msg: "Lead qualificado · interesse em landing · origem Instagram" },
            { at: shiftMin(-46), ok: true, msg: "Lead qualificado · interesse em sistema · origem indicação" },
            { at: at(-1, 21, 12), ok: true, msg: "Lead descartado · fora de escopo, registrado mesmo assim" },
          ],
        },
        {
          id: "stripe",
          ...
          successRate: 97.1,
          avg: "3s",
          summary: "Pagamento confirmado deveria avisar o #pagamentos e lançar o recebimento no financeiro. A última leva falhou na assinatura.",
          nodes: [
            { icon: "card", label: "Evento Stripe" },
            { icon: "shield", label: "Validar assinatura", warn: true },
            { icon: "chat", label: "Discord" },
          ],
          error: "Assinatura do webhook rejeitada · timestamp fora da tolerância de 300s.",
          fixes: { secret: false, tolerance: false, channel: false },
          logs: [
            { at: shiftMin(-12), ok: false, msg: "401 · assinatura inválida · evt_3NexusParcel" },
            { at: shiftMin(-80), ok: false, msg: "401 · timestamp drift +418s · evt_retry" },
            { at: at(-1, 19, 4), ok: true, msg: "invoice.paid notificado em #pagamentos" },
          ],
        },
      ],
      arsenal: [
...
6. Faixa de depoimento em contraste total. Uma voz, cargo, empresa.
...
- Mobile: CTA primário permanece alcançável sem menu.`,
        },
        {
          ...
          tags: ["AI", "DEV"],
          uses: 128,
          body: `Você é o arquiteto de software do Victor Hub AI. Revisa e desenha sistemas web em Next.js, com código que um estúdio de uma pessoa consegue operar.
...
4. Investimento
Valor total, parcelas, o que dispara cada uma.
...
Tom: sóbrio, específico, seguro. Preço na mesma página do escopo.`,
  ...
  window.VHData = { buildSeed, MONTHS };
})();
